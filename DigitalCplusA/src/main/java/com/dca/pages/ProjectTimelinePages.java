...
public class ProjectTimelinePages extends BaseClass {
...
//		
	...
	public void projecttimeline(String selstage, String procheck, String selsdate, String coff, String seledate,
			String comm, String ucareoff) throws InterruptedException {
		addnew.click();
		selectstage.sendKeys(selstage);
		Thread.sleep(3000);
		selprocesscheck.sendKeys(procheck);
		Thread.sleep(3000);
		sdate.sendKeys(selsdate);
		Thread.sleep(3000);
		edate.sendKeys(seledate);
		careof.sendKeys(coff);
		milestone.click();
		Thread.sleep(3000);
		...
		try {
			...
			Thread.sleep(3000);
			edit.click();
			updatecareof.sendKeys(ucareoff);
			update.click();
			Thread.sleep(3000);
			updateok.click();
			Thread.sleep(3000);
