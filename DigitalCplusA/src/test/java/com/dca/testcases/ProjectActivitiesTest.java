...
public class ProjectActivitiesTest extends BaseClass {
	...
	public void projectactivitytest(String stages,String stafftypes,String staffs,String sdate,String edate,String des,String eddate) throws InterruptedException {
		Log.startTestCase("projectactivity");
		LoginPage loginpage=new LoginPage();
		projectpage=loginpage.login();
		projectactivity=projectpage.dropproactivities();
		projectactivity.projectTeam1(stages, stafftypes, staffs, sdate, edate, des, eddate);
