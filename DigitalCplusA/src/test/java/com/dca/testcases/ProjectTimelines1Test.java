...
public class ProjectTimelines1Test extends BaseClass {
	...
	public void protimeline(String selstage,String procheck,String selsdate,String enddate,String coff,String  comm ) throws InterruptedException {
		LoginPage loginpage=new LoginPage();
		projectpage=loginpage.login();
		projecttimelinepages=	projectpage.droptimeline();
		projecttimelinepages.projecttimeline(selstage, procheck, selsdate, coff, enddate, comm);
	}
	@BeforeMethod()
	public void setup() {
	launchApp();
